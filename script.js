...
let sadButtonElement=document.getElementById("triston");
let happyButtonElement=document.getElementById("felis");
let angryButtonElement=document.getElementById("tuputamadre");
